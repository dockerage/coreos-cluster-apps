...
role=$(curl 169.254.169.254/latest/meta-data/iam/info -s | jq --raw-output '.InstanceProfileArn' | sed 's%.*instance-profile/%%')
PS1="\[\033[01;32m\]\u@\h\[\033[01;34m\]-$role \w \$\[\033[00m\]"
alias aws="docker run --rm -it xueshanf/awscli aws"
alias lal="ls -al"
alias ll="ls -l"
alias dk="docker "
alias dkc="dk ps"
